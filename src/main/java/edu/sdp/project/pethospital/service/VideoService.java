...
import edu.sdp.project.pethospital.config.PHVideoWebMvcConfig;
...
public class VideoService {
    ...
    public VideoService() {
        uploadPath = PHVideoWebMvcConfig.videoToStorage;
    }
    ...
    public String storeFile(MultipartFile file) throws FileException {
        ...
        try {
            if (fileName == null) {
                throw new FileException("video not uploaded successfully");
            }
            ...
            throw new FileException("video upload fail");
        }
    }
}
